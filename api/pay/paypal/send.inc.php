...
<input type="hidden" name="notify_url" value="<?php echo DT_PATH;?>api/pay/<?php echo $bank;?>/notify.php" />
...
<input type="hidden" name="item_name" value="<?php echo $charge_title ? $charge_title : $DT['sitename'];?> - 会员[<?php echo $_username;?>]帐户充值" />
