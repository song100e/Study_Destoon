...
<?php } ?>
<td class="px11"><a href="javascript:Dwidget('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&file=order&id=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 报名管理');"><?php echo $v['orders'];?></a></td>
